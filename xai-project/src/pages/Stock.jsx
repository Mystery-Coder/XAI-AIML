		...
		>
			<div className="max-w-5xl mx-auto">
				<div className="text-center mb-8">
					...
					>
						We have trained a machine learning model to predict
						stock prices using key features such as opening price,
						high, low, volume, daily change, and previous day's
						closing price with explainable AI insights.
					</p>
				</div>
				...
				>
						...
						>
							<div className="text-center">
								...
								<div className="flex items-center justify-center gap-3">
									...
									>
										$
										{parseFloat(prediction).toLocaleString(
											"en-US",
											{
					...
					{shapPlot && (
						...
						>
							...
							>
								This plot explains how each feature contributed
